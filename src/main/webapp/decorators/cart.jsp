...
<!-- Bootstrap core CSS -->
<link href="<c:url value='/template/cart/css/bootstrap.min.css'/>" rel="stylesheet" type="text/css">

<!-- Custom styles for this template -->
<link href="<c:url value='/template/cart/css/index.css'/>" rel="stylesheet" type="text/css">
...
<!-- font-awesome -->
<link rel="stylesheet" href="https://use.fontawesome.com/c560c025cf.css" media="all">
